    ...
    return (
        <div className="cardPair">
          <div className="grow giverCard">
            <img className="roboHashImage" alt="user" src={`https://robohash.org/${giver.guid}?200x200`}/>
          ...
          <div className="grow receiverCard">
            <img className="roboHashImage" alt="user" src={`https://robohash.org/${receiver.guid}?200x200`}/>
            <div className="userCard">
